...
spawn(function()
	game:GetService("RunService").Stepped:Connect(function()
		pcall(function()
			if _G.KaitunConfig["Setting"]["Main"]["Start Farm"] then
				if syn then
	...
	while wait() do
		pcall(function()
			for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if (_G.KaitunConfig["Setting"]["Main"]["Safe Mode"] == false and NeedBring) then
...
task.spawn(function()
	while task.wait() do
		pcall(function()
			if _G.KaitunConfig["Setting"]["Main"]["Safe Mode"] == false then
...
local AttackApi = loadstring(game:HttpGet('https://api.realaya.xyz/v1/files/l/o7qg477s4kboyky2c8233i6fj4rxndmv.lua'))()
...
local CodeApi = loadstring(game:HttpGet('https://raw.githubusercontent.com/NoNamePV/Scripts/refs/heads/main/RedeemCode.lua'))()
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/NoNamePV/Utils/refs/heads/main/BloxFruits/QuestData.lua'))()
...
SecondHandle = function()
	...
	elseif _G.KaitunConfig["Item"]["World 2"]["Gravity Cane"] and MyLevel >= 950 and not HaveItem("Gravity Cane") and HaveMob("Fajita") then
		GravityCane()
	elseif _G.KaitunConfig["Item"]["World 2"]["Soul Cane"] and MyBeli >= 3000000 and not HaveTool("Soul Cane") then
		SoulCane()
	elseif _G.KaitunConfig["Item"]["World 2"]["Midnight Blade"] and not HaveTool("Midnight Blade") and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Ectoplasm","Check") >= 100 then
		MidnightBlade()
